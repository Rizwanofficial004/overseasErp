...
export default function JournalEntryItems() {
    ...
    const AddButton = () => {
        ...
        const TABLE_HEAD = [
            ...
            { id: 'isVerified', label: 'Debit', alignRight: false },
            ...
            <Container  maxWidth={themeStretch ? false : 'lg'}>
                <Card>
                    <Scrollbar>
                        ...
                        <h4 style={{marginBottom:15, marginTop:10, textAlign:'center', color:'#ff6347', fontSize:25}}>Rows    </h4>
