...
import AllocationItems from './AllocationsComponents/AllocationItems';
                ...
                <Grid item xs={6} md={6} >
                    <Card height={3} sx={{  p: 1, background: 'rgba(145, 158, 171, 0.12)',borderRadius:1 }} >
                        ...
                        >
                            ...
                            <RHFSelect name="selectSupplier" label="Select a Supplier" placeholder="Payment" size='small'sx={{ background: 'white',borderRadius:1}}>
                                <option value="" />
