...
// _mock_
import { _userList, _paymentterms } from 'src/_mock';
// components
...
// ----------------------------------------------------------------------
    ...
    const [paymentterms, setpaymentterms] = useState([..._paymentterms]);
            ...
            <Container  maxWidth={themeStretch ? false : 'lg'}>
                <Card mt={3}>
                    <Scrollbar>
                        ...
                        <h4 style={{marginBottom:15, marginTop:10, textAlign:'center', color:'#ff6347', fontSize:30}}> Payment Terms Details</h4>
                            <Table>
                                <UserListHead
                                    order={order}
                                    orderBy={orderBy}
                                ...
                                <TableBody >
                                    {paymentterms.map((row) => {
                                        ...
                                        const isItemSelected = selected.indexOf(termsdescription) !== -1;
                                        return (
                                            <TableRow
                                                hover
                                                key={id}
                                            ...
                                            >
                                                ...
                                                <UserMoreMenu onDelete={() => handleDeleteUser(id)} handleEditEvent={() => handleEditEvent(row)} userName={termsdescription} />
                                                </TableCell>
                                            </TableRow>
                                        );
                                    })}
                 ...
                 <DialogAnimate modalWidth='sm' open={isOpenModal} onClose={handleCloseModal}>
                    <DialogTitle>{selectedpaymentterms ? 'Edit Shipping Company Details' : 'Add Shipping Company'}</DialogTitle>
                    <PaymentTermsItemsForm paymentterms={paymentterms} setpaymentterms={setpaymentterms} event={selectedpaymentterms || {}} range={selectedRange} onCancel={handleCloseModal} />
                </DialogAnimate>
            </Container>
        </Page>
    );
