...
export default function SupplierAllocationDashItems() {
    ...
    const AddButton = () => {
        ...
        const TABLE_HEAD = [
            ...
            { id: 'company', label: 'Reference', alignRight: false },
            { id: 'isVerified', label: 'Supplier', alignRight: false },
            { id: 'status', label: 'Suppliers Reference', alignRight: false },
            { id: 'date', label: ' Date', alignRight: false },
            { id: 'status', label: 'Due Date', alignRight: false },
            { id: 'status', label: 'Currency', alignRight: false },
            { id: 'status', label: 'Debit', alignRight: false },
            { id: 'status', label: 'Credit', alignRight: false },
            { id: 'status', label: 'Allocated', alignRight: false },
            { id: 'status', label: 'Balance', alignRight: false },
            { id: '',  alignRight: false },
        ];
