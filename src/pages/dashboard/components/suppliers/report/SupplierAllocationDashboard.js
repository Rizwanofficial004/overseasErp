...
import SupplierTransactionItems from './SupplierTransactionComponents/SupplierTransactionItems';
import SupplierAllocationDashItems from './SupplierAllocationComponents/SupplierAllocationDashItems';


// ----------------------------------------------------------------------

export default function SupplierAllocationDashboard() {
            ...
            <Grid  px={1} py={1}  container spacing={1}  sx={{ border:1,borderColor:'#FB7600',borderRadius:1}} >
                <Grid item xs={3} md={3} >
                    <Card height={3} sx={{  p: 1, background: 'rgba(145, 158, 171, 0.12)',borderRadius:1 }} >
                        ...
                        >
                          <RHFSelect name="allsuppliers" label="All Suppliers" placeholder="Payment" size='small'sx={{ background: 'white',borderRadius:1}}>
                                <option value="" />
                            ...
                            <RHFSelect name="alltypes" label="All Types" placeholder="Payment" size='small'sx={{ background: 'white',borderRadius:1}}>
                                <option value="" />
                                {countries.map((option) => (
                                    <option key={option.code} value={option.label}>
                                        {option.label}
