...
DescriptionFrom.propTypes = {
  event: PropTypes.object,
  // range: PropTypes.object,
  onCancel: PropTypes.func,
};

export default function DescriptionFrom({ event, onCancel, descriptionitems, setdescriptionitems }) {
  ...
  const onSubmit = async (data) => {
    console.log(">>>>>>>>>>:::", data);
    setdescriptionitems([...descriptionitems, data])
    onCancel();
      reset();
    // try {
    //   const newEvent = {
