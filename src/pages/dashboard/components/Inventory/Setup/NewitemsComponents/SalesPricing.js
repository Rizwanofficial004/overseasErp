...
// _mock_
import { _userList, _salespricing,countries } from 'src/_mock';
// components
...
// ----------------------------------------------------------------------
    ...
    const [salespricing, setsalespricing] = useState([..._salespricing]);
    ...
    const [selectedsalespricing, setSelectedsalespricing ] = useState(null)
    ...
    const AddButton = () => {
        ...
        const TABLE_HEAD = [
            { id: 'role', label: 'Currency', alignRight: false },
            { id: 'name', label: 'Price', alignRight: false },
            { id: 'company', label: 'Sales Type', alignRight: false },
            ...
            <Container  maxWidth={themeStretch ? false : 'lg'}>
                <Card>
                    <Scrollbar>
                        ...
                        <h4 style={{ textAlign:'center', color:'black'}}>Sales Pricing Details </h4>
                            ...
                            <Table>
                                ...
                                <TableBody >
                                    {salespricing.map((row) => {
                                        const { id, bold,  currency,
                                        price,
                                        salestype
                                        } = row;
                                        const isItemSelected = selected.indexOf(currency) !== -1;
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell align="left">{salestype}</TableCell>
                                              
                                                <TableCell align="right">
                                                <UserMoreMenu onDelete={() => handleDeleteUser(id)} handleEditEvent={() => handleEditEvent(row)} userName={currency} />
                                                </TableCell>
                                            </TableRow>
                                        );
                                    })}
                 ...
                 <DialogAnimate modalWidth='sm' open={isOpenModal} onClose={handleCloseModal}>
                    <DialogTitle>{selectedsalespricing ? 'Edit Sales Pricing' : 'Add Sales Pricing'}</DialogTitle>
                    <SalespricingForm salespricing={salespricing} setsalespricing={setsalespricing} event={selectedsalespricing || {}} range={selectedRange} onCancel={handleCloseModal} />
                </DialogAnimate>
            </Container>
