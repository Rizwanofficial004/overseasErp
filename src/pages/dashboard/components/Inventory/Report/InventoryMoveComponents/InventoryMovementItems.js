...
export default function InventoryMovementItems() {
    ...
    const AddButton = () => {
        ...
        const TABLE_HEAD = [
            ...
            { id: 'status', label: 'Detail ', alignRight: false },
            { id: 'status', label: 'Quantity In', alignRight: false },
            { id: 'status', label: 'Quantity Out', alignRight: false },
