...
export default function SalesDashboardItems() {
    ...
    const [selectedQuotation, setSelectedQuotation ] = useState(null)
        ...
        const TABLE_HEAD = [
            ...
            { id: 'tmpl', label: 'Tmpl', alignRight: false },
            ...
            <Container  maxWidth={themeStretch ? false : 'lg'}>
                <Card>
                    <Scrollbar>
                        ...
                        <h4 style={{marginBottom:15, marginTop:10, textAlign:'center', color:'#ff6347', fontSize:25}}>SALES ORDER DASHBOARD</h4>
                                    ...
                                    {quoteItems.map((row) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell align="left">{tmpl}</TableCell>
