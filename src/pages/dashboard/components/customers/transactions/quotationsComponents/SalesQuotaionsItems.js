                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {quotationItems.map((row) => {
                                        const { id, itemCode, itemDescription, longDescription, quantity, unit, priceBeforeText, discount, total } = row;
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell align="right">
                                                    <UserMoreMenu onDelete={() => handleDeleteUser(id)} userName={itemCode} />
                                                </TableCell>
                                            </TableRow>
                                        );
                                    })}
