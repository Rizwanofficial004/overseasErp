...
// _mock_
import { _userList, _descriptionitems,countries } from 'src/_mock';
// components
...
import DescriptionFrom from 'src/sections/@dashboard/calendar/inventory/DescriptionForm';
...
// ----------------------------------------------------------------------
    ...
    const [descriptionitems, setdescriptionitems] = useState([..._descriptionitems]);
    ...
    const [selecteddescriptionitems, setSelecteddescriptionitems] = useState(null)
    ...
    const handleEditEvent = (obj) => {
        setSelecteddescriptionitems(obj)
        dispatch(openModal());
    };  
            ...
            <Container  maxWidth={themeStretch ? false : 'lg'}>
                <Card mt={3}>
                                    ...
                                    {descriptionitems.map((row) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <UserMoreMenu onDelete={() => handleDeleteUser(id)} handleEditEvent={() => handleEditEvent(row)} userName={description}/>
                                                </TableCell>
                                            </TableRow>
                                        );
                                    })}
                 ...
                 <DialogAnimate modalWidth='sm' open={isOpenModal} onClose={handleCloseModal}>
                    <DialogTitle>{selecteddescriptionitems ? 'Edit Movement types' : 'Add Movement Types'}</DialogTitle>
                    <DescriptionFrom descriptionitems={descriptionitems} setdescriptionitems={setdescriptionitems} event={selecteddescriptionitems || {}} range={selectedRange} onCancel={handleCloseModal} />
                </DialogAnimate>
            </Container>
        </Page>
    );
